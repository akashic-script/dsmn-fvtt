 ...
 */
export class DSMNActorSheet extends api.HandlebarsApplicationMixin(sheets.ActorSheetV2) {
	constructor(options = {}) {
		super(options);
	...
	static PARTS = {
		header: {
			template: 'systems/dsmn/templates/actor/header.hbs',
		},
		tabs: {
		...
		features: {
			template: 'systems/dsmn/templates/actor/features.hbs',
		},
		description: {
			template: 'systems/dsmn/templates/actor/description.hbs',
		},
		gear: {
			template: 'systems/dsmn/templates/actor/gear.hbs',
		},
		spells: {
			template: 'systems/dsmn/templates/actor/spells.hbs',
		},
		effects: {
			template: 'systems/dsmn/templates/actor/effects.hbs',
		},
	};
